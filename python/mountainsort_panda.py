...
def sort_dataset(*,dataset_dir,output_dir,freq_min=300,freq_max=6000,threshold,interval_size,adjacency_radius,detect_threshold,opts={}):
...
def ms4alg_sort(*,timeseries,firings_out,detect_sign,adjacency_radius,detect_threshold=3,opts={}):
    pp={}
